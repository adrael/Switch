...
Facebook::Facebook(const QString & path, QWidget * parent) : QWidget(parent)
{
    QGroupBox * connection(new QGroupBox("Facebook", this));
    ...
    QPushButton * launch(new QPushButton("Connect to Facebook", this));
