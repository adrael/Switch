...
WindowsLiveMessenger::WindowsLiveMessenger(const QString & path, QWidget * parent) : QWidget(parent)
{
    QGroupBox * connection(new QGroupBox("Windows Live Messenger", this));
    ...
    QPushButton * launch(new QPushButton("Connect to Windows Live Messenger", this));
    ...
    setLayout(layout);
    setObjectName("WindowsLiveMessengerWidget");
}
