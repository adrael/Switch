...
Skype::Skype(const QString & path, QWidget * parent) : QWidget(parent)
{
    QGroupBox * connection(new QGroupBox("Skype", this));
    ...
    QPushButton * launch(new QPushButton("Connect to Skype", this));
